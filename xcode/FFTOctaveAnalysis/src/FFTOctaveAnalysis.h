...
public:
    ...
    void update(){
        ...
        // changing below "audioBuffer.getChannel(1)" to "audioBuffer.getChannel(0)" as voice only has one channel
        myfft.powerSpectrum(0,(int)BUFFER_SIZE_FFT/2, audioBuffer.getChannel(0), BUFFER_SIZE_FFT, &magnitude[0], &phase[0], &power[0], &avg_power);
